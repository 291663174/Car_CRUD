...
<html>
    ...
    <body>
        ...
        <div class="box4" align="center" style="margin: 10px 0 10px 0">
            <table border="2" cellpadding="5" bordercolor="#9DCFFF">
                <!--边框粗细为1像素,单元格和格中的内容距离为4像素,画出的表格看起来是一个单线的表格-->
                <tr>
                    <td colspan="2">
                        <!--在表格中合并了2个列-->
                        <div style="text-align: center;"><b>全部登记车辆信息如下:</b></div>
                    </td>
                <tr>
                ...
                %>
                <tr>
                    <td><a href="user_login_success.jsp">返回登录成功界面</a></td>
                </tr>
            </table>
        </div>
    </body>
